...
return [
    ...
    'connections' => [
        'default' => [
             ...
             */
            'hosts' => [
                env('ES_USER').':'.env('ES_PASS').'@'.env('ES_HOST').':'.env('ES_PORT'),
            ],
    ...
    /*
     * Default elastic index settings
     */
